...
- use the code under AGPL-3.0 (or a commercial license);
- state truthfully that your project "uses Vaultwright" or is "compatible with Vaultwright"
  (nominative use);
- keep the Marks intact in unmodified redistributions.
