...
idempotent recovery of interrupted processing events and explicit failed-event retry. `watch`,
`sync --changed`, `sync --full`, and `reconcile` are still Stage 1B V1-C10 targets and are not
