...
for deterministic startup reconciliation/feed queueing/replay, while continuous native `watch`
delivery remains a Stage 1B V1-C10 target. `index` and `explore` remain gated future work after Stage 1B and the
