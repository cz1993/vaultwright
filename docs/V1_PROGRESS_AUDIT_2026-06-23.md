...
now rejects unsafe or ambiguous domain folders, unsafe note-type/status/frontmatter vocabulary,
unsafe profile artifact paths, invalid repo-mirror folder defaults, and invalid
