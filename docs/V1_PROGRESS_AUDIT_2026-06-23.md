...
now rejects unsafe domain, note-type, status, frontmatter property, and repo-mirror folder default
values before they reach runtime paths, views, repo sync, or lint rules. Preserve the example regeneration gates and
