...
now rejects unsafe domain, note-type, status, and frontmatter property identifiers before they reach
runtime paths, views, or lint rules. Preserve the example regeneration gates and
