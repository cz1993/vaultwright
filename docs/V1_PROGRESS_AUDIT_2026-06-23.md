...
active Office mirror root, and doctor now reports profile-declared generated view state instead of
assuming every profile owns `Documents.base`. Benchmark task/result
