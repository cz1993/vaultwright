...
metadata-first comparison and candidate-only hashing for same-hash move detection. The next Stage
1B slice should remain bounded to watcher-startup reconciliation, changed sync, native watch
