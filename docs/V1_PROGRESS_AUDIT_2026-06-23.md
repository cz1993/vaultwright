...
defaults when mirror config is absent, catalog now separates profile-defined machine-owned Markdown
from curated/domain Markdown counts, and catalog/m365/sandbox/doctor/review/migration reporting
