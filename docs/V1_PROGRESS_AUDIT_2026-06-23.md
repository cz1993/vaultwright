...
defaults when mirror config is absent, catalog and Microsoft 365 handoff now separate
profile-defined machine-owned Markdown from curated/domain Markdown counts, and
catalog/m365/sandbox/doctor/review/migration reporting classifies generated source mirrors from
the active Office mirror root. Benchmark task/result
