...
"""Compatibility shim for package-owned migration reporting."""
...
try:
    from vaultwright.migration import *  # noqa: F403
    from vaultwright.migration import main as _package_main
