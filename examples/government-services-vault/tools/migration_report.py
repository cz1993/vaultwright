...
def main() -> int:
    ...
    if args.normalize_frontmatter_domains and args.json:
        parser.error("--normalize-frontmatter-domains cannot be combined with --json")
    ...
    if args.json:
        ...
        print_worksheet(ROOT, items, frontmatter_items, warnings, errors)
    else:
