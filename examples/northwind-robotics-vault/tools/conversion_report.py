...
"""Compatibility shim for package-owned conversion reporting."""
...
try:
    from vaultwright.conversion import *  # noqa: F403
    from vaultwright.conversion import main as _package_main
